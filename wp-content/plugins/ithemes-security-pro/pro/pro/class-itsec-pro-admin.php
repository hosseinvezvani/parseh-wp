...
class ITSEC_Pro_Admin {
	...
	public function add_plugin_meta_links( $meta ) {
		...
		$meta[] = '<a href="https://zhaket.com/store/arazweb/" target="_blank" rel="noopener noreferrer">' . __( 'Get Support', 'it-l10n-ithemes-security-pro' ) . '</a>';

		return $meta;
	}

	public function itsec_support_url( $support_url ) {
		return 'https://zhaket.com/store/arazweb/';
	}
}
