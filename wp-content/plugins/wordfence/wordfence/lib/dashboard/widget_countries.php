			...
			<div class="wf-dashboard-item-inner">
				<div class="wf-dashboard-item-content">
					<div class="wf-dashboard-item-title">
						<strong>کشورها از نظر تعداد حمله - هفته گذشته</strong>
					</div>
						...
						<div>
							...
							<div class="wf-dashboard-toggle-btns">
								<ul class="wf-pagination wf-pagination-sm">
									<li class="wf-active"><a href="#" class="wf-dashboard-countries" data-grouping="local">سایت محلی</a></li>
									<li><a href="#" class="wf-dashboard-countries" data-grouping="network">شبکه وردفنس</a></li>
								</ul>
							</div>
							<?php endif; ?>
