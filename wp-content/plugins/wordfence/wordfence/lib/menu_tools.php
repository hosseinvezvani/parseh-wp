...
<div class="wrap wordfence">
	<div class="wf-container-fluid">
		...
		$tabsArray[] = array('livetraffic', __('ترافیک زنده'));
		$tabsArray[] = array('whois', __('Whois جستجوی'));
		$tabsArray[] = array('importexport', __('تنظیمات درون ریزی / برون ریزی'));
		$tabsArray[] = array('diagnostics', __('عیب یابی'));
