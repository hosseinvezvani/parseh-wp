...
HTML;
	...
	public static function admin_menus(){
		...
		add_menu_page('Wordfence', "وردفنس{$dashboardExtra}", 'activate_plugins', 'Wordfence', 'wordfence::menu_dashboard', wfUtils::getBaseURL() . 'images/wordfence-logo.svg');
	}
	...
	public static function admin_menus_20() {
		add_submenu_page("Wordfence", "Wordfence Dashboard", "پیشخوان", "activate_plugins", "Wordfence", 'wordfence::menu_dashboard');
	}
	
	public static function admin_menus_30() {
		add_submenu_page("Wordfence", "Firewall", "فایروال", "activate_plugins", "WordfenceWAF", 'wordfence::menu_firewall');
		if (wfConfig::get('displayTopLevelBlocking')) {
			add_submenu_page("Wordfence", "Blocking", "بلاک کردن", "activate_plugins", "WordfenceBlocking", 'wordfence::menu_blocking');
		}
	}
	
	public static function admin_menus_40() {
		add_submenu_page("Wordfence", "Scan", "اسکن", "activate_plugins", "WordfenceScan", 'wordfence::menu_scan');
	}
	
	public static function admin_menus_50() {
		add_submenu_page('Wordfence', 'Tools', 'ابزارها', 'activate_plugins', 'WordfenceTools', 'wordfence::menu_tools');
		if (wfConfig::get('displayTopLevelLiveTraffic')) {
			add_submenu_page("Wordfence", "Live Traffic", "ترافیک زینده", "activate_plugins", "WordfenceLiveTraffic", 'wordfence::menu_tools');
		}
	}
	
	public static function admin_menus_60() {
		if (wfConfig::get('displayTopLevelOptions')) {
			add_submenu_page("Wordfence", "All Options", "همه تنظیمات", "activate_plugins", "WordfenceOptions", 'wordfence::menu_options');
		}
	}
	
	public static function admin_menus_70() {
		add_submenu_page('Wordfence', 'Help', 'راهنما', 'activate_plugins', 'WordfenceSupport', 'wordfence::menu_support');
	}
	
	public static function admin_menus_80() {
		if (wfCentral::isSupported()) {
			add_submenu_page(null, 'Wordfence Central', 'مرکز وردفنس', 'activate_plugins', 'WordfenceCentral', 'wordfence::menu_wordfence_central');
		}
	}
	
	public static function admin_menus_90() {
		if (wfConfig::get('isPaid')) {
			add_submenu_page("Wordfence", "Protect More Sites", "<strong id=\"wfMenuCallout\" style=\"color: #FCB214;\">محافظت از سایت های بیشتر</strong>", "activate_plugins", "WordfenceProtectMoreSites", 'wordfence::_menu_noop');
		}
		else {
			add_submenu_page("Wordfence", "Upgrade To Premium", "<strong id=\"wfMenuCallout\" style=\"color: #FCB214;\">ارتقا به نسخه پریمیوم</strong>", "activate_plugins", "WordfenceUpgradeToPremium", 'wordfence::_menu_noop');
		}
