<?php
if ( file_exists( dirname( __FILE__ ) . '/teeweblang/' . get_locale() . '.mo' ) ){
    load_textdomain( 'wordfence-2fa', dirname( __FILE__ ) . '/teeweblang/' . get_locale() . '.mo' );
}
...
if ($wfCoreActive && !(isset($wfCoreLoading) && $wfCoreLoading)) {
	...
	define('WORDFENCE_LS_BUILD_NUMBER', '1587658822');
