...
require_once 'lib/wfClasses.php'; 

WP_teeweb_wordfence_RtlTheme_02::get_instance();

$check_class = WP_teeweb_wordfence_RtlTheme_02::get_instance();
$rtloauthcheck = $check_class->rtloauthcheck();
if( $rtloauthcheck !== true ) {
    WP_teeweb_wordfence_RtlTheme_01::get_instance();
} else {
...
/**
 * Teeweb Load plugin textdomain.
 */
add_action( 'init', 'wpdocs_load_textdomain' );
function wpdocs_load_textdomain() {
  load_plugin_textdomain( 'wordfence', false, dirname( plugin_basename( __FILE__ ) ) . '/teeweblang' ); 
}

// require_once('lib/wffunctions.php');
